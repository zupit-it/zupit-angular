...
export const NO_AUTH_REDIRECT_URL = new InjectionToken<string>(
  "NO_AUTH_REDIRECT_URL"
);
export const GLOBAL_USER_CONDITION_REDIRECT_URL = new InjectionToken<string>(
  "GLOBAL_USER_CONDITION_REDIRECT_URL"
);
export const SESSION_EXPIRED_REDIRECT_URL = new InjectionToken<string>(
...
export const UNAUTHORIZED_URL_BLACKLIST = new InjectionToken<string>(
