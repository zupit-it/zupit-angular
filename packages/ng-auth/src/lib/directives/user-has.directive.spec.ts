...
@Component({
  template: `
    <div id="any" *ngAuthHas="'roles'; any: ['FOO', 'BAR']">FooBar!</div>
    <div id="all" *ngAuthHas="'roles'; all: ['FOO', 'BAR']">FooBar!</div>
    <div id="eq" *ngAuthHas="'name'; eq: 'foo'">FooBar!</div>
    <div id="eqCondTrue" *ngAuthHas="'name'; eq: 'foo'; cond: 1 === 1">
      FooBar!
    </div>
    <div id="eqCondFalse" *ngAuthHas="'name'; eq: 'foo'; cond: 1 === '1'">
      FooBar!
    </div>
    <div
      id="eqUserCond"
